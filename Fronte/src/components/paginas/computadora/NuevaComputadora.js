...
const Nuevacomputadora = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: computadora => {
            ...
            try {
                ...
                fetch(`http://localhost:3001/computadora/register`, solicitudInit)
                    .then(res => res.json())
    ...
    return (
        <>
            <h1 className="text-3xl font-light mb-4">NUEVA COMPUTADORA</h1>
...
export default Nuevacomputadora;

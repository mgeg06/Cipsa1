...
const  Editusuario = () => {
  ...
  const {id} = useParams();
    ...
    const formik = useFormik( {
        ...
        onSubmit:usuario => { //handelSubmit pasar automaticamnete los datos del formulario
            console.log(usuario);
            ...
            try { // actualizar
               ...
               usuario.existencia = true; 
                ...
                fetch(`http://localhost:3001/usuario/update/${id}`, solicitudInit)
                    .then(res => res.json())
    ...
    return ( 
        <>
            <h1 className="text-3xl font-light mb-4"> EDITAR USUARIO</h1>
